...
#define CAM_FLASH_MAX_LED_TRIGGERS 4 /* LGE CHANGE */
...
/* LGE_CHANGE_S, [EIS], kh.kang@lge.com */
/**
 ...
 *
 * @select                :    pointing which var is updated
 * @actuatorThreadNeeded  :    actuator thread needed
 * @reserved              :    reserved
 */
struct cam_cmd_actuator_userdata {
	__u8               select;
	__u8               actuatorThreadNeeded;
	__u32              reserved;
} __attribute__((packed));
/* LGE_CHANGE_E, [EIS], kh.kang@lge.com */
