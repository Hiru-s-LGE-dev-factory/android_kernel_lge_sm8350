...
#include <linux/module.h>/* LGE_CHANGE, Added icp module_param to replace debugfs, 2020-11-11, dongsu.bag@lge.com */
...
/* LGE_CHANGE_S, Added icp module_param to replace debugfs, 2020-11-11, dongsu.bag@lge.com */
static uint icp_debug_lvl;
module_param(icp_debug_lvl, uint, 0644);

static uint icp_debug_type;
module_param(icp_debug_type, uint, 0644);

static uint icp_fw_dump_lvl;
module_param(icp_fw_dump_lvl, uint, 0644);
/* LGE_CHANGE_E, Added icp module_param to replace debugfs, 2020-11-11, dongsu.bag@lge.com */
...
static int cam_icp_mgr_acquire_hw(void *hw_mgr_priv, void *acquire_hw_args)
{
	...
	uint32_t dump_lvl = 0;/* LGE_CHANGE, Added icp module_param to replace debugfs, 2020-11-11, dongsu.bag@lge.com */
...
#else
		if (icp_hw_mgr.icp_debug_type|icp_debug_type)
			hfi_set_debug_level(icp_hw_mgr.icp_debug_type|icp_debug_type,
				icp_hw_mgr.icp_dbg_lvl |icp_debug_lvl);

		dump_lvl = icp_fw_dump_lvl ? icp_fw_dump_lvl : icp_hw_mgr.icp_fw_dump_lvl;
		hfi_set_fw_dump_level(dump_lvl);
#endif
/* LGE_CHANGE_E, Added icp module_param to replace debugfs, 2020-11-11, dongsu.bag@lge.com */
